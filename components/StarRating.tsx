...
export const StarRating: React.FC<StarRatingProps> = ({ rating, onRatingChange, isEditable = false }) => {
            ...
            {[1, 2, 3, 4, 5].map((index) => (
                ...
                >
                    <StarIcon
                        ...
                        className={isEditable ? "transform transition-transform duration-150 hover:scale-125" : ""}
                    />
                </button>
            ))}
        </div>
