                        ...
                        <div className="relative pl-6 border-l-2 border-gray-200 dark:border-gray-700">
                            {healthHistory.map((event, index) => (
                                <div key={event.id} className="mb-10 relative">
                                    ...
                                    <div className="bg-card-bg p-5 rounded-lg shadow-md border border-card-border ml-4">
                                        <time className="text-sm font-semibold text-text-secondary mb-1 block">
                                        ...
                                        {event.doctor && (
                                            <p className="text-sm font-medium text-gold-600 dark:text-gold-400 my-1">with {event.doctor.name} ({event.doctor.specialty})</p>
                                        )}
                    ...
                    <div className="md:col-span-1 space-y-6 sticky top-28">
                         <div className="bg-card-bg p-6 rounded-lg shadow-md border border-card-border">
                            ...
                            <div className="space-y-3">
                                <button className="w-full bg-gold-400 text-accent-text font-bold py-2 px-4 rounded-lg hover:bg-gold-500 transition-colors">
                                    Book New Appointment
                                </button>
                                <button onClick={onNavigateToAppointments} className="w-full bg-gray-100 text-gray-700 font-bold py-2 px-4 rounded-lg hover:bg-gray-200 dark:bg-charcoal-light dark:text-gray-200 dark:hover:bg-charcoal transition-colors">
                                    View All Appointments
                                </button>
                                <button className="w-full bg-gray-100 text-gray-700 font-bold py-2 px-4 rounded-lg hover:bg-gray-200 dark:bg-charcoal-light dark:text-gray-200 dark:hover:bg-charcoal transition-colors">
                                    Upload a Document
                                </button>
                            </div>
                        </div>
                         <div className="bg-card-bg p-6 rounded-lg shadow-md border border-card-border">
                            <h3 className="text-lg font-bold text-text-primary mb-4">Your Profile</h3>
