    ...
    return (
        <div className="fixed inset-0 bg-black/75 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="bg-card rounded-2xl shadow-2xl w-full max-w-lg relative overflow-hidden max-h-[90vh]">
                ...
                <div className="p-8">
                     <h2 className="text-2xl font-bold text-center text-foreground mb-2">Register as a Doctor</h2>
                     <p className="text-center text-sm text-muted-foreground mb-8">Join our network of healthcare professionals.</p>
                     <form onSubmit={handleSubmit} className="space-y-4 overflow-y-auto max-h-[70vh] pr-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label className="text-sm font-medium text-muted-foreground" htmlFor="gender">Gender</label>
                            ...
                            <div>
                                <label className="text-sm font-medium text-muted-foreground" htmlFor="experience">Years of Experience</label>
                         ...
                         <div>
                            <label className="text-sm font-medium text-muted-foreground" htmlFor="specialization">Specialization</label>
                        ...
                        <div>
                            <label className="text-sm font-medium text-muted-foreground">Upload Doctor Profile Picture</label>
                            <label htmlFor="doctor-image-upload" className={`mt-1 flex justify-center w-full px-6 pt-5 pb-6 border-2 border-dashed rounded-lg cursor-pointer hover:border-accent ${errors.image ? errorBorder : normalBorder}`}>
