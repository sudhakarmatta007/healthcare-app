...
export const OrderConfirmationModal: React.FC<OrderConfirmationModalProps> = ({ order, onClose }) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg relative overflow-hidden p-8 text-center">
                ...
                <p className="text-sm text-gray-600 mt-2 mb-6">
                    Your order ID is <span className="font-semibold text-gray-800">{order.id}</span>. Thank you for your purchase!
                </p>
                
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 text-left space-y-4">
                    <h3 className="text-md font-bold text-gray-800 text-center border-b pb-3 mb-3">Order Summary</h3>
                    <div>
                        <p className="text-xs font-semibold text-gray-500 uppercase">Delivery To</p>
