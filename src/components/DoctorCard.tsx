...
// FIX: Added missing DoctorCardProps interface
    ...
    <div className="bg-card-bg rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 group flex flex-col border border-card-border">
      <div onClick={() => onViewProfile(doctor)} className="cursor-pointer">
        <div className="relative">
          <img className="w-full h-56 object-cover bg-gray-100 dark:bg-charcoal-light" src={doctor.imageUrl} alt={`Dr. ${doctor.name}`} />
        ...
        <div className="p-5">
          ...
          <p className="text-gold-600 dark:text-gold-400 font-semibold text-md mb-2">{doctor.specialty}</p>
